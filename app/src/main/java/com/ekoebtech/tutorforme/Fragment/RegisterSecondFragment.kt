...
import kotlinx.android.synthetic.main.fragment_register_second.view.*
...
class RegisterSecondFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var rootView : View = inflater.inflate(R.layout.fragment_register_second, container, false)
         rootView.nextBtn.setOnClickListener(View.OnClickListener { listener?.onFragmentInteraction(2) })
        return rootView
    }
